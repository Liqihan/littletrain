...
var _matcher = __webpack_require__(105);
...
var _selectorAll = __webpack_require__(104);
...
var _bisect = __webpack_require__(91);
...
var _bisector = __webpack_require__(92);
...
var _deviation = __webpack_require__(94);
...
var _extent = __webpack_require__(96);
...
var _sturges = __webpack_require__(100);
...
var _min = __webpack_require__(101);
...
var _pairs = __webpack_require__(93);
...
var _ticks = __webpack_require__(99);
...
var _transpose = __webpack_require__(102);
...
var _variance = __webpack_require__(95);
...
var _d3Cloud = __webpack_require__(466);

var _d3Cloud2 = _interopRequireDefault(_d3Cloud);

var _result = __webpack_require__(467);

var _result2 = _interopRequireDefault(_result);

var _draw = __webpack_require__(468);
...
var wordCloud = (0, _d3Cloud2.default)().size([500, 500]).words(_result2.default.map(function (d) {
    ...
    return d.size;
}).on("end", _draw.drawCloud).start();

(0, _draw.drawHistgram)(_result2.default);
...
exports.drawHistgram = exports.drawCloud = undefined;
...
var layout = [500, 500];
var drawCloud = exports.drawCloud = function drawCloud(words) {
    d3.select("body").append("svg").attr("width", layout[0]).attr("height", layout[1]).append("g").attr("transform", "translate(" + layout[0] / 2 + "," + layout[1] / 2 + ")").selectAll("text").data(words).enter().append("text").style("font-size", function (d) {
        return d.size + "px";
...
// 画柱状图
var drawHistgram = exports.drawHistgram = function drawHistgram(data, options) {
    ...
    var chart = d3.select("body").append("svg").attr("width", width + margin.left + margin.right).attr("height", height + margin.top + margin.bottom).append("g").attr("transform", "translate(" + margin.left + ", " + margin.top + ")");
    // 画柱状图
    ...
    // 添加坐标轴
    var x = d3.scaleLinear().domain([data.length, 0]).rangeRound([width, 0]);
    // 添加坐标轴
    ...
    }).attr("fill", "#2177BB").attr("width", barWidth - 1);
    bar.append("text").attr("y", function (d) {
        return y(d.size);
    }).attr("dy", -5).attr("x", function (d, i) {
        return (x(i) - x(i - 1)) / 2;
